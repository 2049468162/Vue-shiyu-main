...
<template>
  <div :class="`flex flex-col items-center justify-center gap-4 w-full ${className}`">
    <div
    ...
    >
      <div
        ...
        class="transition-transform duration-200 ease-out text-2xl text-gray-400"
      >
        <slot name="left-icon">
      ...
      >
        ...
        >
          <div class="relative h-full flex-grow overflow-hidden rounded-full bg-gray-600">
    ...
    <p class="text-gray-400 font-medium tracking-wide">{{ Math.round(modelValue) }}岁</p>
  </div>
</template>

<script setup lang="ts">
import { ref, computed, watch, onMounted, useTemplateRef, type Component } from 'vue'
