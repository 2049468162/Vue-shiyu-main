<!--
	Animated Squares Background Component
...
const props = withDefaults(defineProps<Props>(), {
  direction: 'diagonal',
  speed: 0.5,
  borderColor: 'rgba(0, 112, 243, 0.2)', // 主题蓝色，透明度20%
  squareSize: 60,
  hoverFillColor: 'rgba(0, 112, 243, 0.1)' // 主题蓝色，透明度10%
});
...
const drawGrid = () => {
  ...
  gradient.addColorStop(0, 'rgba(10, 14, 39, 0)'); // 中心透明，使用主题深色背景
  gradient.addColorStop(1, 'rgba(10, 14, 39, 0.9)'); // 边缘渐暗
